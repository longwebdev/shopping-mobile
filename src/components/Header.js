        ...
        <header>
            <ul id="slide-out" className="side-nav hidden custom-scrollbar sn-bg-2 ps ps--theme_default" data-ps-id="c27390a3-9efc-e0d8-197a-ab96d73a156a">
                ...
                <li>
                    <ul className="social">
                        <li>
                            <b className="icons-sm fb-ic">
                                <i className="fa fa-facebook"> </i>
                            </b>
                        </li>
                        <li>
                            <b className="icons-sm pin-ic">
                                <i className="fa fa-pinterest"> </i>
                            </b>
                        </li>
                        <li>
                            <b className="icons-sm gplus-ic">
                                <i className="fa fa-google-plus"> </i>
                            </b>
                        </li>
                        <li>
                            <b className="icons-sm tw-ic">
            ...
            <nav className="navbar fixed-top navbar-toggleable-md navbar-expand-lg navbar-dark scrolling-navbar double-nav">
                ...
                <div className="float-left">
                    <b data-activates="slide-out" className="button-collapse">
                ...
                <ul className="nav navbar-nav nav-flex-icons ml-auto">
                    <li className="nav-item dropdown">
                        ...
                        aria-haspopup="true"
                        aria-expanded="false">
                            <i className="fa fa-user"></i> Tài Khoản</b>
                        <div className="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenu1">
                            <b className="dropdown-item waves-effect waves-light">Đăng Ký</b>
                            <b className="dropdown-item waves-effect waves-light">Đăng Nhập</b>
                            <b className="dropdown-item waves-effect waves-light">Đăng Xuất</b>
                        </div>
                    </li>
                </ul>
